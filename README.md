...
-   <span class="package-name">[`@stdlib/assert-has-dataview-support`][@stdlib/assert-has-dataview-support]</span><span class="delimiter">: </span><span class="description">detect native ArrayBuffer support.</span>
